...
pub struct Session {
    ...
    pub server_topic_aliases_by_topic: HashMap<TopicName, u16>,
    pub server_topic_aliases_by_alias: HashMap<u16, (TopicName, u64)>,
    pub server_alias_tick: u64,
...
impl Session {
    pub fn new(config: &Config, peer: SocketAddr) -> Session {
        Session {
            ...
            topic_alias_max: 0,
            server_topic_aliases_by_topic: HashMap::new(),
            server_topic_aliases_by_alias: HashMap::new(),
            server_alias_tick: 0,
